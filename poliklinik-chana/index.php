...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to bottom right, #C8E6C9, #FFFFFF); /* Pastel green gradient */
...
<body class="flex flex-col-reverse md:flex-row items-center h-screen px-10 md:px-28">
    ...
    <div class="flex flex-col gap-5 items-center md:items-start text-center md:text-left">
        <h1 class="text-[#1B5E20] text-5xl md:text-6xl font-bold leading-snug">
            Welcome to <span class="text-[#81C784]">PRECLINIC</span>
        </h1>
    ...
    <div class="flex justify-center md:justify-end mb-10 md:mb-0">
        <img src="assets/images/doktor.png" width="500px" alt="Healthcare Illustration" class="image-shadow">
    </div>
    <!-- Right Side End -->
</body>
