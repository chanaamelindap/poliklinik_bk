...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #B2D8B2, #E6F5E6);
        }
    </style>
</head>
...
<body class="flex h-screen">
    <figure class="basis-1/2 flex justify-center items-center h-full">
        <img src="../assets/images/doktor.png" alt="Illustration of Patient" width="60%">
    </figure>
    ...
    <main class="basis-1/2 relative flex justify-center items-center bg-white shadow-lg rounded-lg">
        ...
        <form action="" method="post" class="w-full px-20">
            <h1 class="text-center text-3xl font-semibold text-[#2E8B57]">Login Pasien</h1>
            <div class="flex flex-col gap-5 mt-7">
                <input type="text" name="username" required placeholder="Username"
                    class="bg-[#E6F5E6] px-5 py-3 outline-none rounded-lg shadow-inner">
                ...
                <button type="submit" name="login"
                    class="mt-3 bg-gradient-to-r from-[#A3D9A5] to-[#7CBF7C] text-white py-3 text-lg font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                    Login
                </button>

                <div class="flex justify-center gap-2 mt-4">
                    <h1 class="text-gray-600">Belum punya akun?</h1>
                    <a href="registrasi_pasien.php" class="text-[#2E8B57] font-medium underline">Registrasi</a>
                </div>
            </div>
        </form>
    </main>
