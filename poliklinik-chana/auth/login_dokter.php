...
<head>
    ...
    <style>
        ...
        .focus-ring {
            focus:ring-2 focus:ring-[#A8E6CF];
        }
...
<body class="flex h-screen gradient-bg">
    ...
    <figure class="w-1/2 flex justify-center items-center">
        <img src="../assets/images/doktor.png" alt="Doctor Illustration" class="max-w-full h-auto">
    </figure>
    ...
    <main class="w-1/2 flex justify-center items-center bg-white shadow-xl rounded-xl p-10">
        ...
        <form action="" method="post" class="w-full max-w-sm">
            <h1 class="text-center text-3xl font-semibold text-[#388E3C] mb-6">Login Dokter</h1>
            
            <!-- Username & Password Input -->
            <div class="flex flex-col gap-6">
                <input type="text" name="username" required placeholder="Username"
                    class="bg-gray-200 px-5 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#A8E6CF]">
            ...
            <button type="submit" name="login"
                class="w-full mt-6 bg-[#388E3C] text-white py-3 font-medium rounded-lg button-hover transition-all">
                Login
            </button>
        </form>
    </main>
