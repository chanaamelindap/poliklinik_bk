...
<body class="flex justify-center items-center h-[100vh] gap-5 bg-[#e6f7e6]">
    <main class="bg-white w-[750px] p-9 rounded-2xl">
        <form action="" method="post" class="flex flex-col gap-5 mt-5">
            ...
            <button type="submit" name="submit" class="bg-[#66cc66] w-fit py-3 px-6 text-white font-medium rounded-lg">Edit
                Data</button>
        </form>
    </main>
</body>
