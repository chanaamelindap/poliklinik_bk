...
<body class="flex gap-5">
    ...
    <main class="flex flex-col w-full bg-white pb-10 rounded-lg shadow-lg">
        <!-- Header -->
        <header class="flex items-center gap-3 px-8 py-7 bg-[#C8E6C9] text-white rounded-t-lg">
        ...
        <article class="px-8 py-5">
            <form action="" method="post" class="flex flex-col gap-5 bg-white p-8 shadow-lg rounded-lg">
                <h2 class="text-xl font-semibold text-[#388E3C]">Tambah Data Dokter</h2>
                ...
                <button type="submit" name="submit" class="bg-[#388E3C] py-3 px-6 text-white font-medium rounded-lg hover:bg-[#2E7D32]">
                    Tambah Data
                </button>
            </form>
            ...
            <section class="mt-8 p-8 bg-white shadow-lg rounded-lg">
                <h2 class="mb-5 text-2xl font-medium text-[#388E3C]">Daftar Dokter</h2>
                        ...
                        <?php while ($item = mysqli_fetch_assoc($dokter)) : ?>
                            <tr class="border-t">
                                ...
                                <td class="py-5 text-center flex justify-center gap-3">
                                    <a href="edit_dokter.php?id=<?= $item["id"] ?>" class="bg-[#43A047] px-4 py-2 rounded-lg text-white hover:bg-[#388E3C]">
                                        Edit
                                    </a>
                                    <a href="hapus_dokter.php?id=<?= $item["id"] ?>" class="bg-[#E53935] px-4 py-2 rounded-lg text-white hover:bg-[#D32F2F]">
                                        Delete
                                    </a>
                                </td>
                            </tr>
