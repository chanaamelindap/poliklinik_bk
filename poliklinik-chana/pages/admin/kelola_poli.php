        ...
        <article>
            ...
            <form action="" method="post" class="flex flex-col gap-5 mt-8 p-8 bg-white rounded-2xl shadow-md">
                <div class="flex flex-col gap-3">
                    <label for="nama_poli" class="text-lg font-medium text-[#388E3C]">Nama Poli</label>
                ...
                <div class="flex flex-col gap-3">
                    <label for="keterangan" class="text-lg font-medium text-[#388E3C]">Keterangan</label>
                        ...
                        <tr>
                            ...
                            <td class="border py-5 text-center">
                                <a href="edit_poli.php?id=<?= $item["id"] ?>"
                                    class="bg-[#43A047] px-6 py-2 rounded-lg text-white mr-3 hover:bg-[#388E3C] transition-all">Edit</a>
