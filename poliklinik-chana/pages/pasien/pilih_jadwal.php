...
<body class="flex gap-5 bg-[#EAF4E3]">
    ...
    <main class="flex flex-col w-full bg-[#D7E9C9] pb-10">
         <header class="flex items-center gap-3 px-8 py-7 shadow-lg bg-[#A3D9A5]">
        ...
        <article class="flex gap-2 px-3">
            <div class="w-1/2 mt-8 mx-auto">
                <h1 class="bg-[#A3D9A5] px-5 py-4 text-white text-xl font-medium rounded-t-2xl">Langkah 2</h1>
                <form action="" method="post" class="flex flex-col gap-5 h-fit px-6 py-5 bg-[#EAF4E3] rounded-b-2xl">
                    ...
                    <button type="submit" name="submit"
                        class="bg-[#4CAF50] w-full mx-auto py-3 px-6 text-white font-medium rounded-lg">Lanjut</button>
                </form>
            </div>
        </article>
    </main>
