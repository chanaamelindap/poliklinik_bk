...
<body class="flex justify-center items-center h-[100vh] gap-5 bg-[#C8E6C9]">
    <main class="bg-white w-[750px] p-9 rounded-2xl">
        <form action="" method="post" class="flex flex-col gap-5 mt-5">
            ...
            <div class="flex flex-col gap-3">
                ...
                <select id="hari" name="hari" class="px-4 py-3 outline-none rounded-lg border border-gray-300">
                    <?php
            ...
            <div class="flex flex-col gap-3">
                ...
                <input type="time" name="jam_mulai" id="jam_mulai" value="<?= $jadwal_periksa["jam_mulai"] ?>"
                    class="px-4 py-3 border border-gray-300 outline-none rounded-lg">
            </div>
            ...
            <button type="submit" name="submit" class="bg-[#388E3C] w-fit py-3 px-6 text-white font-medium rounded-lg">Edit Data</button>
        </form>
    </main>
</body>
