...
<body class="flex gap-5">
    ...
    <main class="flex flex-col w-full bg-white pb-10 rounded-lg shadow-lg">
        <header class="flex items-center gap-3 px-8 py-7 shadow-lg" style="background: #A5D6A7;">
            <img src="../../assets/icons/notebook-pen.svg" alt="" width="30px" class="invert">
            <h1 class="text-3xl font-medium text-white">Riwayat Pasien</h1>
        </header>

        <article class="mx-8 mt-8 p-8 bg-white shadow-lg rounded-lg">
            <h2 class="text-2xl font-medium text-[#388E3C] mb-5">Daftar Riwayat Pasien</h2>
            <table class="w-full table-auto border border-gray-300">
                ...
                <tbody class="bg-white">
                    ...
                    <tr class="border-t">
                        ...
                        <td class="py-5 text-center">
                            <a href="detail_periksa.php?id=<?= $item["id"] ?>" class="action-button px-6 py-2 rounded-lg text-white">Detail</a>
                        </td>
                    </tr>
                    <?php $index++ ?>
                    <?php endforeach; ?>
