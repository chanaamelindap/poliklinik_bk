                    ...
                    <tr class="border-t">
                        ...
                        <td class="py-5 text-center flex justify-center gap-3">
                            ...
                            if ($item["status_periksa"] == "Menunggu") {
                                echo '<a href="edit_periksa_pasien.php?id=' . $item["id"] . '" class="bg-[#81C784] px-4 py-2 rounded-lg text-white">Periksa</a>';
                            } else {
                                echo '<a href="edit_periksa_pasien.php?id=' . $item["id"] . '" class="bg-[#66BB6A] px-4 py-2 rounded-lg text-white">Edit</a>';
                            }
                            ?>
                        </td>
