...
<body class="flex gap-5">
    ...
    <main class="flex flex-col w-full bg-white pb-10 rounded-lg shadow-lg">
        <header class="flex items-center gap-3 px-8 py-7 shadow-lg">
            ...
            <h1 class="text-3xl font-medium">Kelola Obat</h1>
        </header>

        <article class="px-8 py-5">
            <form action="" method="post" class="flex flex-col gap-5 bg-white p-8 shadow-lg rounded-lg">
                <h2 class="text-xl font-semibold text-[#388E3C]">Tambah Data Obat</h2>
            ...
            <section class="mt-8 p-8 bg-white shadow-lg rounded-lg">
                <h2 class="mb-5 text-2xl font-medium text-[#388E3C]">Daftar Obat</h2>
                <table class="w-full table-auto border border-gray-300">
                    <thead class="bg-[#81C784] text-white">
                        <tr>
                            <th class="w-[5%] py-3">No</th>
                            <th class="w-[20%] py-3">Nama Obat</th>
                            <th class="w-[25%] py-3">Kemasan</th>
                            <th class="w-[20%] py-3">Harga</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr class="border-t">
                            ...
                            <td class="py-5 text-center">Rp
                                <?= $item["harga"] ?>
                            </td>
                            <td class="py-5 text-center flex justify-center gap-3">
                                <a href="edit_obat.php?id=<?= $item["id"] ?>" class="bg-[#43A047] px-4 py-2 rounded-lg text-white hover:bg-[#388E3C]">
                                    Edit
                                </a>
                                <a href="hapus_obat.php?id=<?= $item["id"] ?>" class="bg-[#E53935] px-4 py-2 rounded-lg text-white hover:bg-[#D32F2F]">
                                    Delete
                                </a>
                            </td>
                        </tr>
