...
<body class="flex flex-col-reverse md:flex-row items-center h-screen px-10 md:px-28">
    ...
    <div class="flex flex-col gap-5 items-center md:items-start text-center md:text-left">
        ...
        Providing reliable healthcare solutions for you and your loved ones. 
        Experience exceptional medical care that's fast, professional, and patient-centered!
        </p>
    ...
    <div class="flex justify-center md:justify-end mb-10 md:mb-0">
        <img src="assets/images/doktor.png" width="900px" alt="Healthcare Illustration" class="">
    </div>
    <!-- Right Side End -->
</body>
